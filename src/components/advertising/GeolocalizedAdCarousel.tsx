...
export const GeolocalizedAdCarousel = ({ userLocation = "Libreville", className }: GeolocalizedAdCarouselProps) => {
          ...
          >
            ...
            <div className="relative h-full flex flex-col justify-center items-center text-center p-6 text-white">
              ...
              <Button 
                ...
                onClick={() => console.log(`CTA clicked for slide ${slide.id} in ${userLocation}`)}
              >
                {slide.cta}
              </Button>
            </div>
