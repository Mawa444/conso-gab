...
interface BusinessMessageBubbleProps {
...
export const BusinessMessageBubble: React.FC<BusinessMessageBubbleProps> = ({
  message,
  isOwn,
  showAvatar,
  isGrouped,
  ...
  return (
    ...
    >
        ...
        <div className="w-8 h-8 flex-shrink-0">
          {showAvatar ? (
            <Avatar className="w-8 h-8">
              <AvatarImage src={businessLogoUrl || message.sender?.profile_picture_url} />
              <AvatarFallback className="bg-gradient-to-br from-primary to-accent text-white text-xs">
                {message.sender?.pseudo?.charAt(0).toUpperCase() || 'B'}
              </AvatarFallback>
            </Avatar>
          ) : (
            <div className="w-8" />
      ...
      >
        {/* Icône de type de message si ce n'est pas du texte */}
      ...
      {/* Espace pour l'avatar côté droit */}
