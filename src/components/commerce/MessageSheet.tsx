...
export const MessageSheet = ({ open, onClose, commerce }: MessageSheetProps) => {
  ...
  const handleSend = () => {
    ...
    console.log('Envoi du message:', { commerce: commerce.id, message, type: activeTab });
    onClose();
    setSelectedTemplate('');
    setCustomMessage('');
  };
        ...
        <div className="p-4">
              ...
              {getCurrentTemplates().map((template, index) => (
                <Button
                  ...
                  className={cn(
                    ...
                    selectedTemplate === template && "bg-[hsl(var(--gaboma-green))] text-white"
                  )}
          ...
          <div className="space-y-4">
            <Textarea
              placeholder={
                activeTab === 'message'
                  ...
                  : "Ou personnalisez votre message..."
              }
              value={customMessage}
            ...
            <Button
              ...
              className="w-full h-12 bg-[hsl(var(--gaboma-green))] text-white hover:bg-[hsl(var(--gaboma-green))]/90 font-medium"
            >
              Envoyer le message
            </Button>
