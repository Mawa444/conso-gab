          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2">
                <Button variant="outline" size="sm" onClick={() => setShowQuickMessage(true)} className="flex-1 gap-1 rounded-3xl bg-[1e7be6] bg-[#1e7be6]/[0.97] text-[ffd014] text-white/[0.96]">
